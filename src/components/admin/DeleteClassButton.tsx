...
import { deleteClass } from '@/lib/mutations/classes';
      ...
      {showModal && (
        ...
        >
          ...
          >
            ...
            <p className="text-sm text-ink-soft mb-2">Estás por eliminar:</p>
            <p className="font-bold uppercase tracking-wide text-sm mb-5">{name}</p>
